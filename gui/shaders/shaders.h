...
extern const char _binary_texture_vert[];
extern const unsigned long _binary_texture_vert_size;
...
extern const char _binary_texture_frag[];
extern const unsigned long _binary_texture_frag_size;
