...
float
dfm09_temp(const DFM09Subframe_PTU *ptu, const DFM09Calib *calib)
{
...
uint32_t
dfm09_seq(const DFM09Subframe_GPS *gps)
{
	return bitmerge(gps->data + 3, 8);
}

int
dfm09_time(const DFM09Subframe_GPS *gps)
{
	return bitmerge(gps->data + 4, 16) / 1000;
}

void
dfm09_date(struct tm *dst, const DFM09Subframe_GPS *gps)
{
...
float
dfm09_lat(const DFM09Subframe_GPS *gps)
{
	return (int32_t)bitmerge(gps->data, 32) / 1e7;
}

float
dfm09_lon(const DFM09Subframe_GPS *gps)
{
	return (int32_t)bitmerge(gps->data, 32) / 1e7;
}
float
dfm09_alt(const DFM09Subframe_GPS *gps)
{
	return (int32_t)bitmerge(gps->data, 32) / 1e2;
}

float
dfm09_speed(const DFM09Subframe_GPS *gps)
{
	return bitmerge(gps->data + 4, 16) / 1e2;
}

float
dfm09_heading(const DFM09Subframe_GPS *gps)
{
	return bitmerge(gps->data + 4, 16) / 1e2;
}

float
dfm09_climb(const DFM09Subframe_GPS *gps)
{
